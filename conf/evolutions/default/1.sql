...
create table formulario_estudiante (
  ...
  anos_trabajo3                 varchar(255),
  anos_trabajo2                 varchar(255),
  titulo                        varchar(255),
  titulo2                       varchar(255),
  institucion                   varchar(255),
  institucion2                  varchar(255),
  idiomas                       varchar(255),
  otros_titulos                 varchar(255),
  otros_titulos_formales        varchar(255),
  otros_trabajos                varchar(255),
  estado_laboral                varchar(255),
  ano_ingreso_formal            varchar(255),
  ano_final_formal              varchar(255),
  ano_ingreso_formal2           varchar(255),
  ano_final_formal2             varchar(255),
